...
void FlacPlayer::App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs ^ e) {
	OnActivated(e);
}
void FlacPlayer::App::OnActivated(Windows::ApplicationModel::Activation::IActivatedEventArgs ^ e)
{
#if _DEBUG
	...
	bool needActivate = rootFrame == nullptr;
	...
	if (rootFrame->Content == nullptr || e->Kind == ActivationKind::PickFileContinuation
		|| e->Kind == ActivationKind::File)
	{
